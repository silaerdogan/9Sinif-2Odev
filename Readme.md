...
**Cevap:** **Grafiğin eğimini 22,8 N/m buldum.**
...
**Cevap:** **Grafiğimin eğim formülü 21.6x+0.253 olarak buldum.**

c) Elle çizdiğiniz grafik orijinden geçmiyor.  *x=0* iken *y=0* değil. *x=0* iken *y* nedir? Sizce neden orjinden geçmiyor?      

**Cevap:** **Yayı çizerken yapılan küçük sapmalardan dolayı doğru orijinden geçmez.**
...
**Cevap**: **Bulduğum değer -640. Yani videodaki değerle eşit.**
...
6. Grafiği defterinize çiziniz.Sonra size verdiğim google sheet örneğini kullanarak bilgisayar ile grafiği çiziniz. Değerler yakın mı? Google sheet dosyasının bağlantısını ver. [cevap:e-tablolar dosyası](https://docs.google.com/spreadsheets/d/1LOoEoMMjMKWggoWzTdTzOn_BEfS1jvhvMnVlEFgBzG8/edit#gid=0). 
